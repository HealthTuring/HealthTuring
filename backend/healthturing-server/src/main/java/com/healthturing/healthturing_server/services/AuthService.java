 ...
 * Emplea los repositorios de user y verificationToken, los servicios JwtService y EmailSenderService
 * y las clases AtuhenticacionManager, PasswordEncoder (Servicios implementados) y ValidationFunctions(localizado en validations)
 */
@Service
public class AuthService {
    ...
    /**
     * Función de login que comprueba que las credenciales son correctas y devueleve un token
     * @param email
     * @param password
     * @return String token
     */
