...
<h1>HealthTuring - Aplicación Web Sanitaria</h1>
  ...
  <h3>Descripción</h3>
  <p>SaludConnect es una aplicación web diseñada para facilitar la gestión de tratamientos médicos, reservas de citas, seguimiento de historial clínico y comunicación directa entre pacientes y doctores a través de un chat en línea. Este proyecto ha sido desarrollado como trabajo de fin de curso del ciclo formativo en desarrollo de aplicaciones web.</p>
  ...
  <ol>
    <li>Registrarse como paciente o médico.</li>
    <li>Acceder a la plataforma y gestionar perfil e historial.</li>
    <li>Reservar citas desde el calendario.</li>
    <li>Visualizar tratamientos asignados.</li>
    <li>Usar el chat para contactar con el profesional médico.</li>
  </ol>
  <p><img src="ruta/a/captura1.png" alt="Captura de pantalla 1"></p>
  <p><img src="ruta/a/captura2.png" alt="Captura de pantalla 2"></p>

  <h3>Código Fuente</h3>
  <p>Repositorio actualizado semanalmente: <a href="https://github.com/usuario/saludconnect" target="_blank">https://github.com/usuario/saludconnect</a></p>

  <h3>Despliegue de la Aplicación</h3>
  <p><a href="https://saludconnect.vercel.app" target="_blank">https://saludconnect.vercel.app</a></p>
  ...
  <p><a href="https://www.figma.com/file/ejemplo/saludconnect" target="_blank">Diseño en Figma</a></p>
...
<h2>Enlaces a Notion</h2>
<ul>
    <li>    
        <a href="https://messy-muskox-c6b.notion.site/Anteproyecto-1c053eb02c1e800b8074d49e43f14007">Anteproyecto</a>
    </li>
    <li>    
        <a href="https://messy-muskox-c6b.notion.site/1e553eb02c1e80b99aecd3bc1395805c?v=1e553eb02c1e80009cd4000cb875567c">Bitácora de tareas</a>
    </li>
